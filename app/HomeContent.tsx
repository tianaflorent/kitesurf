        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="rounded-2xl overflow-hidden shadow-lg">
            <Image
              ...
              alt="Baie de Sakalava vue du ciel – spot de kitesurf à Diego Suarez, Madagascar"
              width={800}
              height={320}
      ...
      <div className="flex gap-6 overflow-x-auto snap-x snap-mandatory scroll-smooth pb-6 scrollbar-hide">
        {[
          ...
          <div key={i} className="snap-center shrink-0 w-[80%] sm:w-[60%] lg:w-[30%] rounded-2xl overflow-hidden shadow-lg group">
            <Image src={`/images/${img}`} alt={alt} width={800} height={320} className="w-full h-80 object-cover group-hover:scale-105 transition duration-500" />
          </div>
        ))}
        <div className="snap-center shrink-0 w-[80%] sm:w-[60%] lg:w-[30%] rounded-2xl overflow-hidden shadow-lg relative group cursor-pointer">
          <Image src="/images/IMG-20260304-WA0038.jpg" alt="Galerie photos kitesurf Baie de Sakalava Madagascar" width={800} height={320} className="w-full h-80 object-cover group-hover:scale-105 transition duration-500" />
